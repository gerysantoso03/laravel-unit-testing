<nav class="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
      <span class="self-center text-2xl text-blue-700 hover:text-blue-500 font-semibold whitespace-nowrap dark:text-white">Sqiva</span>
  </a>
  <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      <button type="button" class="flex justify-center items-center h-8 w-8 bg-gray-200 text-sm rounded-full cursor-pointer md:me-0 focus:ring-4 focus:ring-slate-300 dark:focus:ring-slate-100" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
